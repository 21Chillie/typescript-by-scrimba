...
2. Type the props
3. Explicitly type all variables inside of Keyboard
*/
...
export default function Keyboard({ alphabet, guessedLetters, currentWord, isGameOver, addGuessedLetter }: KeyboardProps): JSX.Element {
